...
data_root = '/home/yy/project/s2anet/data/360_pretrain/'
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'Train/test.json',
        img_prefix=data_root + 'Train/images/',
        pipeline=test_pipeline))
# optimizer
...
log_level = 'INFO'
work_dir = 'work_dirs/s2anet_r50_fpn_1x_ms_rotate_360_pre_hrsc/'
load_from =  '/home/yy/project/s2anet/work_dirs/s2anet_r101_fpn_3x_360(&hrsc ship epoch40)/epoch_40.pth'  # None  # 
resume_from =  '/home/yy/project/s2anet/work_dirs/s2anet_r50_fpn_1x_ms_rotate_360_pre_hrsc/latest.pth'    # None  #    
workflow = [('train', 1)]
