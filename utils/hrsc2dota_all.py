...
from DOTA_devkit.dota_poly2rbox import rbox2poly_single
...
def generate_txt_labels(root_path):
    ...
    label_txt_path = osp.join(root_path, 'labelTxt_all')
...
if __name__ == '__main__':
    ...
    generate_txt_labels('/home/yy/project/s2anet/data/HRSC2016/FullDataSet')
    # generate_txt_labels('/home/yy/project/s2anet/data/HRSC2016/Train')
    # generate_txt_labels('/home/yy/project/s2anet/data/HRSC2016/Test')
    print('done!')
