...
#  DOTA数据的txt文件夹
txtFolder = r"/home/yy/project/s2anet/data/dota/train/labelTxt"
#  DOTA数据的image文件夹
imgFolder = r"/home/yy/project/s2anet/data/dota/train/images"
#  要复制到的image文件夹
copy_imageFolder = r"/home/yy/project/s2anet/data/dota_ship/images" # /home/yy/project/s2anet/data/dota_ship
#  要复制到的txt文件夹
copy_txtFolder = r"/home/yy/project/s2anet/data/dota_ship/labelTxt"
#  感兴趣类别
selected_class = "ship"
