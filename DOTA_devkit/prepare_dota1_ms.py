...
from DOTA_devkit.DOTA2COCO import DOTA2COCOTrain, DOTA2COCOTest, wordname_16
...
if __name__ == '__main__':
    # single scale
    prepare_multi_scale_data('/home/yy/data/dota',
                             '/home/yy/data/dota_1024_ms_s2anet',scales=[1.0])
    # multi scale
