...
from DOTA_devkit.DOTA2JSON2016 import generate_json_labels
...
if __name__ == '__main__':
    hrsc2016_dir = '/home/yy/project/s2anet/data/HRSC2016/'  # /home/yy/project/s2anet/data/HRSC2016/Train(or Test)/images下要有图片
